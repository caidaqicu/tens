...
public class ProblemController {
    ...
    public Result newList(@PathVariable String label, @PathVariable int page, @PathVariable int size) {
        Page<Problem> page1 = problemService.findNewListByLabelId(label, page, size);
        return new Result(true, StatusCode.OK, "", new PageResult(page1.getTotalElements(), page1.getContent()));
    }
    ...
    public Result hotlist(@PathVariable String label, @PathVariable int page, @PathVariable int size) {
        Page<Problem> page1 = problemService.findHotListByLabelId(label, page, size);
        return new Result(true, StatusCode.OK, "", new PageResult(page1.getTotalElements(), page1.getContent()));
    }
    ...
    public Result waitlist(@PathVariable String label, @PathVariable int page, @PathVariable int size) {
        Page<Problem> page1 = problemService.findWaitListByLabelId(label, page, size);
        return new Result(true, StatusCode.OK, "", new PageResult(page1.getTotalElements(), page1.getContent()));
    }
